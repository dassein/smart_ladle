...
def plot_importance(importance_feature, name_feature):
    ...
    plt.tight_layout()
    plt.savefig('./lightGBM_importance_best.png')
    plt.show()
...
if __name__ == "__main__":
    ...
    #     'metric': ['l2', 'auc'],
    #     'learning_rate': 0.001,  # best for temp
    #     'feature_fraction': 0.9,
    #     'bagging_fraction': 0.7,
    #     'bagging_freq': 10,
    #     'verbose': 0,
    #     "max_depth": 8,
    #     "num_leaves": 100,  # best for temp
    #     "max_bin": 512,
    #     "num_iterations": 100000,
    #     "n_estimators": 1000  # best for temp
    # }
    '''save and load models'''
    gbm_temp = joblib.load('./lightGBM_temp_best.pkl')
    gbm_slope = joblib.load('./lightGBM_slope_best.pkl')
    ...
    name_feature = list(pd.read_csv("../data/train.csv").columns[: -2])
    print(name_feature)
