...
if __name__ == "__main__":
    ...
    joblib.dump(gbm_temp , './lightGBM_temp.pkl')
    joblib.dump(gbm_slope, './lightGBM_slope.pkl')
    gbm_temp_load  = joblib.load('./lightGBM_temp.pkl')
    gbm_slope_load = joblib.load('./lightGBM_slope.pkl')